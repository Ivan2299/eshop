...
const Delivery = () => {
	return (
		<div>
			<h1 className={s.delivery_title}>Доставка</h1>
			<div className={s.delivery_section}>
				<span className={s.delivery_span}>
					{' '}
			...
			<div className={s.delivery_section}>
				<span className={s.delivery_span}>1914 translation by H. Rackham</span> "But I must explain
			...
			<div className={s.delivery_section}>
				<span className={s.delivery_span}>" 1914 translation by H. Rackham </span> "On the other
