...
const Payment = () => {
	return (
		<div>
			<h1 className={s.payment_title}>Оплата</h1>
			<div className={s.payments_section}>
				<span className={s.payment_span}> Section 1.10.32 of "de Finibus Bonorum et Malorum",</span>{' '}
				written by Cicero in 45 BC "Sed ut perspiciatis unde omnis iste natus error sit voluptatem
			...
			<div className={s.payments_section}>
				<span className={s.payment_span}>1914 translation by H. Rackham</span> "But I must explain
				to you how all this mistaken idea of denouncing pleasure and praising pain was born and I
			...
			<div className={s.payments_section}>
				<span className={s.payment_span}> Section 1.10.32 of "de Finibus Bonorum et Malorum",</span>{' '}
				written by Cicero in 45 BC "At vero eos et accusamus et iusto odio dignissimos ducimus qui
			...
			<div className={s.payments_section}>
				<span className={s.payment_span}>" 1914 translation by H. Rackham </span> "On the other
				hand, we denounce with righteous indignation and dislike men who are so beguiled and
